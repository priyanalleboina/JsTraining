...
class AdressServer {
    static createContact(pid, name, age, hno, colName, street) {
        axios_1.default({
            method: 'get',
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.getContactsList = exports.addContactInfo = void 0;
const addressServer_1 = __webpack_require__(/*! ./addressServer */ "./src/addressServer.ts");
function addContactInfo() {
    const pid = document.getElementById('pid');
    const name = document.getElementById('name');
    const age = document.getElementById('age');
    const hno = document.getElementById('hno');
    const street = document.getElementById('street');
    const colName = document.getElementById('colName');
    addressServer_1.default.createContact(Number(pid.value), name.value, Number(age.value), hno.value, street.value, colName.value);
}
exports.addContactInfo = addContactInfo;
function getContactsList() {
    addressServer_1.default.getContacts().then((resp) => {
